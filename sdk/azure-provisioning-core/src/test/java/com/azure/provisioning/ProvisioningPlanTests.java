...
//
    ...
    public void lintWarn() {
        ...
        ProvisioningParameter param = new ProvisioningParameter("endpoint", String.class);
        infra.add(param);
    ...
    public void lintError() {
        ...
        ProvisioningParameter param = new ProvisioningParameter("bar", Integer.class);
        param.setValue(BicepValue.from("Hello, World."));
        infra.add(param);
